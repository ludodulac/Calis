...
import { handstandProgression, v1Resources } from "@/lib/content/v1";
import styles from "./handstand-path.module.css";
...
const situations = [
  ...
  ["Je tiens au mur mais pas sans mur", "Le problème devient moins la force brute que la capacité à sentir et corriger de petits déplacements au-dessus des mains.", "/bibliotheque/premiers-equilibres-handstand", "Passer du mur à l'équilibre"],
] as const;
