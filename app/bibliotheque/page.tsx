...
export default function LibraryPage() {
  return <main>
    ...
    <section className="section sectionSoft"><div className="shell"><div className="sectionHeading"><div className="eyebrow">Explorer librement</div><h2>Recherche dans toute la bibliothèque</h2><p>Recherche un mouvement, un besoin ou du matériel, puis affine par niveau, capacité, parcours ou matériel. Toutes les fiches restent accessibles ici sans transformer la bibliothèque en longue liste avant même que tu aies choisi quoi chercher.</p></div><LibraryBrowser resources={v1Resources} /></div></section>
  </main>;
}
